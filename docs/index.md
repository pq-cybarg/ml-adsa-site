...
| **Machine-checked lemmas** | **137** (105 EasyCrypt + 32 Coq) + **6** Gobra code-level theorems |
| **Genuineness** | **34/34** — each proof's named primitive is weakened and the proof confirmed to break |
