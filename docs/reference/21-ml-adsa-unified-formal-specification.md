...
Totals: **23 algorithm-proof artifacts** (14 EC + 4 EasyPQC + 5 Coq), all green, 24/24 EC
...
Run all evidence:
```
formal/check-all.sh            # 23 algorithm-proof artifacts GREEN
formal/genuineness.sh          # 24/24 EC genuineness
