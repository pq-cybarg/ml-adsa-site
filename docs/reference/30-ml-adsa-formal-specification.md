...
> Status note (honest): the scheme's security is established by 200 machine-checked lemmas (168 EasyCrypt
> + 32 Coq) across 33 prover artifacts, plus 6 Gobra code-level theorems (tallies reproducible via
