...
> Status note (honest): the scheme's security is established by 153 machine-checked lemmas (121 EasyCrypt
> + 32 Coq) across 30 prover artifacts, plus 6 Gobra code-level theorems (tallies reproducible via
