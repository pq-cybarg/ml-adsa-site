...
The scheme is accompanied by **174 machine-checked lemmas** (142 EasyCrypt + 32 Coq) across **32 prover
...
6. **A reproducible assurance package**: 174 machine-checked lemmas across 32 prover artifacts (+6 Gobra
...
proofs** — 174 lemmas (142 EasyCrypt + 32 Coq) across 32 artifacts, plus 6 Gobra code-level theorems, spanning EasyCrypt (classical + QROM via the EasyPQC fork), Coq, and Gobra; (ii)
