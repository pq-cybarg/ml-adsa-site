...
| **Machine-checked lemmas** | **194** (162 EasyCrypt + 32 Coq) + **6** Gobra code-level theorems |
| **Genuineness** | **43/43** — each proof's named primitive is weakened and the proof confirmed to break |
