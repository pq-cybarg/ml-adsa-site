...
| 3 | Machine-checked proofs (beyond required, a differentiator) | **DONE** | 162 lemmas (130 EC + 32 Coq) across 32 artifacts + 6 Gobra; `formal/count-artifacts.sh`, `docs/31`, `docs/35` |
