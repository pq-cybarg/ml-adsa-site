...
> Status note (honest): the scheme's security is established by 137 machine-checked lemmas (105 EasyCrypt
> + 32 Coq) across 29 prover artifacts, plus 6 Gobra code-level theorems (tallies reproducible via
