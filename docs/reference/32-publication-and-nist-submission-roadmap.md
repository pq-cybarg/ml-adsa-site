...
| 3 | Machine-checked proofs (beyond required, a differentiator) | **DONE** | 156 lemmas (124 EC + 32 Coq) across 31 artifacts + 6 Gobra; `formal/count-artifacts.sh`, `docs/31`, `docs/35` |
