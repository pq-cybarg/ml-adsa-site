...
| 3 | Machine-checked proofs (beyond required, a differentiator) | **DONE** | 137 lemmas (105 EC + 32 Coq) across 29 artifacts + 6 Gobra; `formal/count-artifacts.sh`, `docs/31`, `docs/35` |
