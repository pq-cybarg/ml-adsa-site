...
| **Machine-checked lemmas** | **168** (136 EasyCrypt + 32 Coq) + **6** Gobra code-level theorems |
| **Genuineness** | **38/38** — each proof's named primitive is weakened and the proof confirmed to break |
