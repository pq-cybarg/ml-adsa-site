...
> Status note (honest): the scheme's security is established by 77 machine-checked proofs (EasyCrypt
> classical + QROM, Coq, Gobra) reducing to the same assumptions as ML-DSA, plus a CIRCL/go-qrllib-anchored
