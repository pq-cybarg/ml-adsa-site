...
- **Proofs** (`formal/`): the algorithm is verified abstractly — 32 machine-checked artifacts (22 EC +
  5 EasyPQC + 5 Coq), 45/45 EC genuineness; plus **Gobra** code-level proofs of the structural logic
...
```
formal/check-all.sh            # proofs: 33 artifacts GREEN
formal/genuineness.sh          # 45/45
