...
> Status note (honest): the scheme's security is established by 254 machine-checked lemmas (222 EasyCrypt
> + 32 Coq) across 38 prover artifacts, plus 6 Gobra code-level theorems (tallies reproducible via
