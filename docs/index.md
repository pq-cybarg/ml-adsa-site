...
| **Machine-checked lemmas** | **158** (126 EasyCrypt + 32 Coq) + **6** Gobra code-level theorems |
| **Genuineness** | **36/36** — each proof's named primitive is weakened and the proof confirmed to break |
