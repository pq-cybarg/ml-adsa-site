...
| **Machine-checked lemmas** | **162** (130 EasyCrypt + 32 Coq) + **6** Gobra code-level theorems |
| **Genuineness** | **37/37** — each proof's named primitive is weakened and the proof confirmed to break |
