...
| 3 | Machine-checked proofs (beyond required, a differentiator) | **DONE** | 153 lemmas (121 EC + 32 Coq) across 30 artifacts + 6 Gobra; `formal/count-artifacts.sh`, `docs/31`, `docs/35` |
