...
| **Machine-checked lemmas** | **191** (159 EasyCrypt + 32 Coq) + **6** Gobra code-level theorems |
| **Genuineness** | **42/42** — each proof's named primitive is weakened and the proof confirmed to break |
