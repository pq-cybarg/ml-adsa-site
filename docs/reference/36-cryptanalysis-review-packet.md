...
**Machine-checked (35 prover artifacts, 234 lemmas = 202 EasyCrypt + 32 Coq, 49/49 genuineness, 6 Gobra;
...
cd formal && zsh check-all.sh          # → ALL GREEN (25 classical + 5 quantum + 5 Coq)
