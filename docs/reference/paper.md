...
The scheme is accompanied by **156 machine-checked lemmas** (124 EasyCrypt + 32 Coq) across **31 prover
...
6. **A reproducible assurance package**: 156 machine-checked lemmas across 31 prover artifacts (+6 Gobra
...
proofs** — 156 lemmas (124 EasyCrypt + 32 Coq) across 31 artifacts, plus 6 Gobra code-level theorems, spanning EasyCrypt (classical + QROM via the EasyPQC fork), Coq, and Gobra; (ii)
