...
| 3 | Machine-checked proofs (beyond required, a differentiator) | **DONE** | 134 lemmas (102 EC + 32 Coq) across 29 artifacts + 6 Gobra; `formal/count-artifacts.sh`, `docs/31`, `docs/35` |
