...
The scheme is accompanied by **137 machine-checked lemmas** (105 EasyCrypt + 32 Coq) across **29 prover
...
6. **A reproducible assurance package**: 137 machine-checked lemmas across 29 prover artifacts (+6 Gobra
...
proofs** — 137 lemmas (105 EasyCrypt + 32 Coq) across 29 artifacts, plus 6 Gobra code-level theorems, spanning EasyCrypt (classical + QROM via the EasyPQC fork), Coq, and Gobra; (ii)
