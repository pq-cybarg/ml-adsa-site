...
Totals: **35 algorithm-proof artifacts** (25 EC + 5 EasyPQC + 5 Coq), all green, 49/49 EC
...
Run all evidence:
```
formal/check-all.sh            # 35 algorithm-proof artifacts GREEN
formal/genuineness.sh          # 49/49 EC genuineness
