...
> Status note (honest): the scheme's security is established by 260 machine-checked lemmas (228 EasyCrypt
> + 32 Coq) across 39 prover artifacts, plus 6 Gobra code-level theorems (tallies reproducible via
