...
Totals: **36 algorithm-proof artifacts** (26 EC + 5 EasyPQC + 5 Coq), all green, 50/50 EC
...
Run all evidence:
```
formal/check-all.sh            # 36 algorithm-proof artifacts GREEN
formal/genuineness.sh          # 50/50 EC genuineness
