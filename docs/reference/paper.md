...
The scheme is accompanied by **168 machine-checked lemmas** (136 EasyCrypt + 32 Coq) across **32 prover
...
6. **A reproducible assurance package**: 168 machine-checked lemmas across 32 prover artifacts (+6 Gobra
...
proofs** — 168 lemmas (136 EasyCrypt + 32 Coq) across 32 artifacts, plus 6 Gobra code-level theorems, spanning EasyCrypt (classical + QROM via the EasyPQC fork), Coq, and Gobra; (ii)
