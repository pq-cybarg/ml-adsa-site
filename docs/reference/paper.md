...
The scheme is accompanied by **153 machine-checked lemmas** (121 EasyCrypt + 32 Coq) across **29 prover
artifacts** (20 classical EasyCrypt + 5 quantum EasyPQC + 5 Coq/Rocq), plus **6 Gobra code-level theorems**
...
6. **A reproducible assurance package**: 153 machine-checked lemmas across 30 prover artifacts (+6 Gobra
...
proofs** — 153 lemmas (121 EasyCrypt + 32 Coq) across 30 artifacts, plus 6 Gobra code-level theorems, spanning EasyCrypt (classical + QROM via the EasyPQC fork), Coq, and Gobra; (ii)
