...
The scheme is accompanied by **158 machine-checked lemmas** (126 EasyCrypt + 32 Coq) across **31 prover
artifacts** (21 classical EasyCrypt + 5 quantum EasyPQC + 5 Coq/Rocq), plus **6 Gobra code-level theorems**
...
6. **A reproducible assurance package**: 158 machine-checked lemmas across 31 prover artifacts (+6 Gobra
...
proofs** — 158 lemmas (126 EasyCrypt + 32 Coq) across 31 artifacts, plus 6 Gobra code-level theorems, spanning EasyCrypt (classical + QROM via the EasyPQC fork), Coq, and Gobra; (ii)
